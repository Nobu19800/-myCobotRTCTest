...
mycobottesttest_spec = ["implementation_id", "myCobotTestTest",
		 "type_name",         "myCobotTestTest",
...
##
# @class myCobotTestTest
# @brief myCobot Test Component
#
#
class myCobotTestTest(OpenRTM_aist.DataFlowComponentBase):
...
def myCobotTestTestInit(manager):
    profile = OpenRTM_aist.Properties(defaults_str=mycobottesttest_spec)
    manager.registerFactory(profile,
                            myCobotTestTest,
                            OpenRTM_aist.Delete)

def MyModuleInit(manager):
    myCobotTestTestInit(manager)

    # Create a component
    comp = manager.createComponent("myCobotTestTest")
